...
因此已知三人位置 Cris (0,0) Carlinhos (X,0) Marcel (X/2,Y)、以及Cris和Marcel吹气球的速度，求Carlinhos吹气球速度至少为多少，使得最终气球碰到/相切时，Carlinhos的气球面积≥其他人的面积
...
`s.lower_bound(x)` 寻找满足 Si ≥ x 的最小鞋码，返回迭代器`pos`。
...
直接写较困难，通过观察input和output，可总结出一个式子，核心部分一行代码解决，ac
